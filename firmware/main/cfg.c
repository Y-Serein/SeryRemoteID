...
static rid_config_t s_cfg = {
    ...
    .input_profile = RID_INPUT_PROFILE_GENERIC_MAVLINK,
...
static const rid_param_t s_params[] = {
    ...
    PARAM_DEF("INPUT_PROFILE", RID_PARAM_UINT8, input_profile, RID_INPUT_PROFILE_GENERIC_MAVLINK, RID_INPUT_PROFILE_GENERIC_MAVLINK, RID_INPUT_PROFILE_CUSTOM_MAVLINK, RID_PARAM_FLAG_NONE, 0),
